...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ModPlyr *modPlyr = [ModPlyr alloc];
    
    NSMutableArray *fileUrls = [modPlyr getModDirectoryContents];
    
    NSURL *fileOneUrl = [fileUrls objectAtIndex:3];
    NSURL *docsDir = [self applicationDocumentsDirectory];
    
    NSLog(@"File: %@", [fileOneUrl path]);
      
    
    [modPlyr playMod:[fileOneUrl path]];  
    return YES;
}
